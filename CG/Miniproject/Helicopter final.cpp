...
void drawcopter()
{
glColor3f(0.7,1.0,1.0); glRectf(10,49.8,19.8,44.8);//body
...
glColor3f(1.0,1.0,1.0); renderBitmapString(35,85,0,GLUT_BITMAP_HELVETICA_18,"------MET BKC IOE------");

renderBitmapString(41,80,0,GLUT_BITMAP_HELVETICA_12,"  Nashik,Maharashtra");

glColor3f(1.0,1.0,0.0);
renderBitmapString(20,65,0,GLUT_BITMAP_8_BY_13,"        A mini project for Computer Graphics Laboratary");
...
glutInitWindowSize (800, 600); glutInitWindowPosition (200,200);
